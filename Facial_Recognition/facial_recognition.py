...
folder_path = os.path.join(
    "C:/Users/Rhyan Shah/Documents/GitHub/cosmosfinal/Facial_Recognition/Datasets",
    user_name,
)
...
if guessing_process == True:
    ...
    while True:
        ...
        if k % 256 == 32:
            fo = os.chdir(
                "C:/Users/Rhyan Shah/Documents/GitHub/cosmosfinal/Facial_Recognition/TestingData"
            )
    ...
    with open(
        "C:/Users/Rhyan Shah//Documents/GitHub/cosmosfinal/Facial_Recognition/accuracy.txt",
        "a",
    ) as fhand:
